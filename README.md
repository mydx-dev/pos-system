...
```bash
git clone git@github.com:mydx-dev/pos-system.git
cd pos-system
```
...
本番環境向け GAS ビルドは workspace package の環境別 script を使います。

```bash
pnpm --filter @mydx-pos/gas build:prd
```
